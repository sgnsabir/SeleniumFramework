...
import sleniumframework.pageobjects.BannerPage;
...
public class PageTitleValidation extends BaseTest {
	...
	public void addBannerValidation() {
		...
		AssertJUnit.assertEquals(banner.testCasesButton(), "Automation Practice Website for UI Testing - Test Cases");
		AssertJUnit.assertEquals(banner.apiListButton(), "Automation Practice for API Testing");
